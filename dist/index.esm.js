...
import { union, get as get$3 } from 'lodash';
...
var DefaultTemplate = function (_a) {
    ...
    var error = schema.type !== 'object' ? get$3(methods.formState.errors, fieldName) : '';
    /**
...
function BaseInput(_a) {
    ...
    var fieldName = (schema === null || schema === void 0 ? void 0 : schema.parentKey) ? "".concat(schema === null || schema === void 0 ? void 0 : schema.parentKey, ".").concat(name) : name;
    var error = get$3(methods.formState.errors, fieldName);
    return (jsxRuntime.exports.jsx(Controller, { name: fieldName, rules: { required: required }, control: methods.control, render: function (_a) {
            var field = _a.field;
