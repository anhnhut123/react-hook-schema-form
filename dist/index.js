...
var mergeSchemas = function (obj1, obj2) {
    ...
    return Object.keys(obj2).reduce(function (acc, key) {
        ...
        if (obj1 && obj1.hasOwnProperty(key) && isObject$5(right)) {
            ...
            // "required" fields.
            acc[key] = lodash.union(left, right);
        }
        else {
            acc[key] = right;
        }
...
var isFilesArray = function (schema, uiSchema, rootSchema) {
    if (rootSchema === void 0) { rootSchema = {}; }
...
var getDisplayLabel = function (schema, uiSchema, rootSchema) {
    if (uiSchema === void 0) { uiSchema = {}; }
...
var DefaultArrayItem = function (props) {
    ...
    //   fontWeight: 'bold',
    // }
    return (jsxRuntime.exports.jsx("div", __assign({ className: props.className }, { children: jsxRuntime.exports.jsx("div", __assign({ className: props.hasToolbar ? 'col-xs-9' : 'col-xs-12' }, { children: props.children })) }), props.key));
};
var DefaultNormalArrayFieldTemplate = function (props) {
    return (jsxRuntime.exports.jsxs("fieldset", __assign({ className: props.className, id: props.idSchema.$id }, { children: [jsxRuntime.exports.jsx(ArrayFieldTitle, { TitleField: props.TitleField, idSchema: props.idSchema, title: props.uiSchema['ui:title'] || props.title, required: props.required }, "array-field-title-".concat(props.idSchema.$id)), (props.uiSchema['ui:description'] || props.schema.description) && (jsxRuntime.exports.jsx(ArrayFieldDescription, { DescriptionField: props.DescriptionField, idSchema: props.idSchema, description: props.uiSchema['ui:description'] || props.schema.description }, "array-field-description-".concat(props.idSchema.$id))), jsxRuntime.exports.jsx("div", { children: props.items && props.items.map(function (p) { return DefaultArrayItem(p); }) }, "array-item-list-".concat(props.idSchema.$id))] })));
};
var NormalArray = function (_a) {
    ...
    var arrayFields = reactHookForm.useFieldArray({
        control: control,
        name: name
    }).fields;
...
var isItemRequired = function (itemSchema) {
...
var BooleanField = function (_a) {
    var name = _a.name, schema = _a.schema, registry = _a.registry, idSchema = _a.idSchema, uiSchema = _a.uiSchema, readonly = _a.readonly, required = _a.required, disabled = _a.disabled, methods = _a.methods;
    var title = schema.title;
    var widgets = registry.widgets, formContext = registry.formContext, fields = registry.fields;
    ...
    return (jsxRuntime.exports.jsx(Widget, { methods: methods, id: idSchema && idSchema.$id, options: __assign(__assign({}, options), { enumOptions: enumOptions }), schema: schema, name: name, label: !title ? name : title, required: required, disabled: disabled, readonly: readonly, registry: registry, formContext: formContext, DescriptionField: fields.DescriptionField, uiSchema: uiSchema }));
};

var DescriptionField = function (_a) {
    _a.id; var description = _a.description;
    if (!description)
        return null;
    if (typeof description === 'string')
        return jsxRuntime.exports.jsx("p", { children: description });
    return jsxRuntime.exports.jsx("div", { children: description });
};
...
var NumberField = function (props) {
    ...
    return jsxRuntime.exports.jsx(StringField, __assign({ type: "number" }, props));
};

var DefaultObjectFieldTemplate = function (_a) {
    var TitleField = _a.TitleField, DescriptionField = _a.DescriptionField, rest = __rest(_a, ["TitleField", "DescriptionField"]);
    return (jsxRuntime.exports.jsxs("fieldset", __assign({ id: rest.idSchema.$id }, { children: [(rest.uiSchema['ui:title'] || rest.title) && (jsxRuntime.exports.jsx(TitleField, { id: "".concat(rest.idSchema.$id, "__title"), title: rest.title || rest.uiSchema['ui:title'], required: rest.required, formContext: rest.formContext })), rest.description && (jsxRuntime.exports.jsx(DescriptionField, { id: "".concat(rest.idSchema.$id, "__description"), description: rest.description, formContext: rest.formContext })), rest.properties.map(function (prop) { return prop.content; })] })));
};
var ObjectField = function (_a) {
    ...
    try {
        ...
        return (jsxRuntime.exports.jsxs("div", { children: [jsxRuntime.exports.jsxs("p", { children: ["Invalid ", name || 'root', " object field configuration:", jsxRuntime.exports.jsx("span", { children: err.message }), "."] }), jsxRuntime.exports.jsx("p", { children: JSON.stringify(schema) })] }));
    }
...
var ImageHelper = function (_a) {
    var uiSchema = _a.uiSchema;
    if (!(uiSchema === null || uiSchema === void 0 ? void 0 : uiSchema.sources) || !(uiSchema === null || uiSchema === void 0 ? void 0 : uiSchema.sources.length))
        return null;
    var title = uiSchema.title, sources = uiSchema.sources;
    return (jsxRuntime.exports.jsxs("div", { children: [title && jsxRuntime.exports.jsx("div", __assign({ className: "help mt-1 d-block text-secondary" }, { children: title })), jsxRuntime.exports.jsx("div", __assign({ className: "d-flex align-items-center" }, { children: sources.map(function (url, index) { return (jsxRuntime.exports.jsx("img", { src: url, style: { width: 50, height: 50, borderRadius: 8 } }, index)); }) }))] }));
};
...
var Help = function (_a) {
    ...
    if (typeof help === 'string')
        return jsxRuntime.exports.jsx("p", { children: help });
    return jsxRuntime.exports.jsx("span", { children: help });
};
var DefaultTemplate = function (_a) {
    var children = _a.children, required = _a.required, displayLabel = _a.displayLabel, methods = _a.methods, label = _a.label, name = _a.name, uiSchema = _a.uiSchema, schema = _a.schema, imageHint = _a.imageHint;
    var fieldName = (schema === null || schema === void 0 ? void 0 : schema.parentKey) ? "".concat(schema === null || schema === void 0 ? void 0 : schema.parentKey, ".").concat(name) : name;
    var help = uiSchema['ui:help'];
    var error = schema.type !== 'object' ? lodash.get(methods.formState.errors, fieldName) : '';
    /**
     * Note: when schema type is object, dont need to show error field
     */
    var errorMessage = error ? (error === null || error === void 0 ? void 0 : error.message) || "".concat(label || 'This field', " is required") : '';
    return (jsxRuntime.exports.jsxs("div", __assign({ className: "mb-3 ".concat(error ? 'invalid' : 'valid') }, { children: [displayLabel && (jsxRuntime.exports.jsxs("label", __assign({ className: "form-label mb-1" }, { children: [label, " ", required && jsxRuntime.exports.jsx("span", __assign({ className: "text-danger" }, { children: "*" }))] }))), jsxRuntime.exports.jsxs("div", { children: [children, (help || error) && (jsxRuntime.exports.jsx("div", __assign({ className: "help mt-1 d-block ".concat(error ? 'invalid-feedback' : 'text-secondary') }, { children: errorMessage || help }))), imageHint] })] })));
};
var SchemaField = function (_a) {
    var _b;
    var name = _a.name, _c = _a.uiSchema, uiSchema = _c === void 0 ? {} : _c, registry = _a.registry, methods = _a.methods, idPrefix = _a.idPrefix, idSeparator = _a.idSeparator, required = _a.required, rest = __rest(_a, ["name", "uiSchema", "registry", "methods", "idPrefix", "idSeparator", "required"]);
    ...
    if (Object.keys(schema).length === 0)
        return null;
    var field = (jsxRuntime.exports.jsx(FieldComponent, { name: name, idSchema: idSchema, schema: schema, uiSchema: uiSchema, methods: methods, formContext: formContext, disabled: disabled, readonly: readonly, registry: registry, required: required }));
    var id = idSchema.$id;
...
var StringField = function (_a) {
    ...
    var Widget = getWidget(schema, widget, widgets);
    return (jsxRuntime.exports.jsx(Widget, __assign({}, rest, { name: name, schema: schema, uiSchema: uiSchema, label: title === undefined ? name : title, required: required, methods: methods, registry: registry, options: __assign(__assign({}, rest.options), { enumOptions: enumOptions }) })));
};
...
var TitleField = function (_a) {
    ...
    if (!title)
        return null;
    return (jsxRuntime.exports.jsxs("div", { children: [jsxRuntime.exports.jsx("p", { children: title }), required && jsxRuntime.exports.jsx("span", { children: REQUIRED_FIELD_SYMBOL })] }, id));
};

var UnsupportedField = function () {
    return jsxRuntime.exports.jsx("div", { children: "This field is unsupported" });
};
...
function BaseInput(_a) {
    var name = _a.name, required = _a.required, readonly = _a.readonly, methods = _a.methods, uiSchema = _a.uiSchema, disabled = _a.disabled, type = _a.type, schema = _a.schema;
    var fieldName = (schema === null || schema === void 0 ? void 0 : schema.parentKey) ? "".concat(schema === null || schema === void 0 ? void 0 : schema.parentKey, ".").concat(name) : name;
    var error = lodash.get(methods.formState.errors, fieldName);
    return (jsxRuntime.exports.jsx(reactHookForm.Controller, { name: fieldName, rules: { required: required }, control: methods.control, render: function (_a) {
            var field = _a.field;
            return (jsxRuntime.exports.jsx("input", __assign({ className: "form-control ".concat(error ? 'is-invalid' : ''), disabled: disabled, readOnly: readonly, placeholder: (uiSchema === null || uiSchema === void 0 ? void 0 : uiSchema['ui:placeholder']) || '', type: type }, field)));
        } }));
}

function CheckboxWidget(_a) {
    var name = _a.name, schema = _a.schema, disabled = _a.disabled, readonly = _a.readonly, label = _a.label, required = _a.required, DescriptionField = _a.DescriptionField, methods = _a.methods;
    var fieldName = (schema === null || schema === void 0 ? void 0 : schema.parentKey) ? "".concat(schema === null || schema === void 0 ? void 0 : schema.parentKey, ".").concat(name) : "".concat(name);
    return (jsxRuntime.exports.jsx(reactHookForm.Controller, { name: fieldName, rules: { required: required }, control: methods.control, render: function (_a) {
            var field = _a.field;
            return (jsxRuntime.exports.jsxs("div", __assign({ className: "form-check" }, { children: [schema.description && jsxRuntime.exports.jsx(DescriptionField, { description: schema.description }), jsxRuntime.exports.jsx("input", __assign({ className: "form-check-input", type: "checkbox", disabled: disabled, readOnly: readonly, id: name }, field)), jsxRuntime.exports.jsx("label", __assign({ className: "form-check-label", htmlFor: name }, { children: label }))] })));
        } }));
}

function CheckboxesWidget(_a) {
    var id = _a.id, disabled = _a.disabled, options = _a.options, readonly = _a.readonly, name = _a.name, methods = _a.methods, schema = _a.schema, required = _a.required;
    var register = methods.register;
    var enumOptions = options.enumOptions, enumDisabled = options.enumDisabled;
    var fieldName = (schema === null || schema === void 0 ? void 0 : schema.parentKey) ? "".concat(schema === null || schema === void 0 ? void 0 : schema.parentKey, ".").concat(name) : "".concat(name);
    return (jsxRuntime.exports.jsx("div", __assign({ className: "checkboxes", id: id }, { children: enumOptions.map(function (option, index) {
            var itemDisabled = enumDisabled && enumDisabled.indexOf(option.value) !== -1;
            var disabledCls = disabled || itemDisabled || readonly ? 'disabled' : '';
            return (jsxRuntime.exports.jsxs("div", __assign({ className: "form-check" }, { children: [jsxRuntime.exports.jsx("input", __assign({ type: "checkbox", className: "form-check-input", id: "".concat(id, "_").concat(index), defaultValue: option.value, disabled: !!disabledCls }, register("".concat(fieldName), {
                        disabled: disabled || itemDisabled || readonly,
                        required: required
                    }))), jsxRuntime.exports.jsx("label", __assign({ className: "form-check-label", htmlFor: "".concat(id, "_").concat(index) }, { children: option.label }))] }), "".concat(id, "_").concat(index)));
        }) })));
}

function SelectWidget(_a) {
    var name = _a.name, schema = _a.schema, id = _a.id, options = _a.options, methods = _a.methods, required = _a.required, disabled = _a.disabled, readonly = _a.readonly, multiple = _a.multiple, placeholder = _a.placeholder;
    var register = methods.register;
    var enumOptions = options.enumOptions, enumDisabled = options.enumDisabled;
    var fieldName = (schema === null || schema === void 0 ? void 0 : schema.parentKey) ? "".concat(schema === null || schema === void 0 ? void 0 : schema.parentKey, ".").concat(name) : "".concat(name);
    return (jsxRuntime.exports.jsxs("select", __assign({ id: id, multiple: multiple, className: "form-control", required: required, disabled: disabled || readonly }, register(fieldName, { required: required, disabled: disabled }), { children: [!multiple && schema["default"] === undefined && jsxRuntime.exports.jsx("option", __assign({ value: "" }, { children: placeholder })), enumOptions.map(function (_a, i) {
                var value = _a.value, label = _a.label;
                var disabled = enumDisabled && enumDisabled.indexOf(value) !== -1;
                return (jsxRuntime.exports.jsx("option", __assign({ value: value, disabled: disabled }, { children: label }), i));
            })] })));
}

function TextWidget(props) {
    var BaseInput = props.registry.widgets.BaseInput;
    return jsxRuntime.exports.jsx(BaseInput, __assign({}, props));
}

function TextareaWidget(_a) {
    var name = _a.name, required = _a.required, methods = _a.methods, schema = _a.schema, uiSchema = _a.uiSchema, disabled = _a.disabled;
    var register = methods.register;
    var fieldName = (schema === null || schema === void 0 ? void 0 : schema.parentKey) ? "".concat(schema === null || schema === void 0 ? void 0 : schema.parentKey, ".").concat(name) : "".concat(name);
    return (jsxRuntime.exports.jsx("textarea", __assign({ className: "form-control", placeholder: (uiSchema === null || uiSchema === void 0 ? void 0 : uiSchema['ui:placeholder']) || '' }, register(fieldName, { required: required, disabled: disabled }))));
}

function RadioWidget(_a) {
    var id = _a.id, disabled = _a.disabled, options = _a.options, readonly = _a.readonly, name = _a.name, methods = _a.methods, schema = _a.schema, required = _a.required;
    var register = methods.register;
    var enumOptions = options.enumOptions, enumDisabled = options.enumDisabled;
    var fieldName = (schema === null || schema === void 0 ? void 0 : schema.parentKey) ? "".concat(schema === null || schema === void 0 ? void 0 : schema.parentKey, ".").concat(name) : "".concat(name);
    return (jsxRuntime.exports.jsx("div", __assign({ className: "radios", id: id }, { children: enumOptions.map(function (option, index) {
            var itemDisabled = enumDisabled && enumDisabled.indexOf(option.value) !== -1;
            var disabledCls = disabled || itemDisabled || readonly ? 'disabled' : '';
            return (jsxRuntime.exports.jsxs("div", __assign({ className: "form-check" }, { children: [jsxRuntime.exports.jsx("input", __assign({ type: "radio", className: "form-check-input", id: "".concat(id, "_").concat(index), defaultValue: option.value, disabled: !!disabledCls }, register("".concat(fieldName), {
                        disabled: disabled || itemDisabled || readonly,
                        required: required
                    }))), jsxRuntime.exports.jsx("label", __assign({ className: "form-check-label", htmlFor: "".concat(id, "_").concat(index) }, { children: option.label }))] }), "".concat(id, "_").concat(index)));
        }) })));
...
function Form(_a) {
    ...
    var registry = {
        ...
        widgets: __assign(__assign({}, widgets), (rest.widgets || {})),
    ...
    return (jsxRuntime.exports.jsx("form", __assign({ onSubmit: typeof onSubmit === 'function' && !children ? rest.methods.handleSubmit(onSubmit) : undefined }, { children: jsxRuntime.exports.jsx(Form$1, __assign({ platform: "web", registry: registry }, rest, { children: typeof onSubmit === 'function' && !children ? (jsxRuntime.exports.jsx("button", __assign({ type: "submit", className: "btn btn-primary" }, { children: submitText || 'Submit' }))) : (children) })) })));
}
